...
Here are the lecture notes for the module **Inverse Problems in Geophysics.**, tailored for Master's students of Geophysics or Geoinformatics at the [Institute of Geophysics and Geoinformatics, TU Bergakademie Freiberg](https://tu-freiberg.de/geophysik).
You can access all the materials on the GitHub repository <https://github.com/halbmy/InversionGeophysics>.
...
* Menke (2012) [@Menke2012]:  [Geophysical Data Analysis: Discrete Inverse Theory](https://www.sciencedirect.com/book/9780128135556/geophysical-data-analysis), Academic
* Richter (2020): [Inverse Problems: Basics, Theory and Applications in Geophysics](https://link.springer.com/book/10.1007/978-3-030-59317-9)
* Günther (2004): [Inversion Methods and Resolution Analysis for the 2D/3D Reconstruction of Resistivity Structures from DC Measurements](http://nbn-resolving.de/urn:nbn:de:swb:105-4152277),
PhD thesis
...
* [Electromagnetics](https://tubaf-em.github.io/Geoelektrik_Elektromagnetik/) (5. BGIP), [Theory EM](https://ruboerner.github.io/ThEM/),
