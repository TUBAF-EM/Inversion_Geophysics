...
This course was already existing in the early 2000s when I did my PhD that was a lot about inversion and regularization, back then with exercises in Matlab.
In 2020, I held this course using [Julia](https://julialang.org) as programming language.
After starting as professor, I mainly transferred the slides from LaTeX to Quarto and switched back from Julia to Python in 2026.
As the course is again slightly adapted, the content of the slides is step by step moving into the script and enriched by the Notebooks shown in the lectures.
Any feedback (mistakes, ideas, missing content) is highly welcome!
...
In the following code snippets, we assume the following imports
```
import numpy as np
...
- see also [Reference list @sec-refs]
